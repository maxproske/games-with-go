// https://youtu.be/C_fbO5GAwXY?t=1240

// Value noise is interpolation between random points.
// Gradient noise is interpolation between random slopes.

// Types of cohertemt noise:
// Perlin noise is used as an umbrella term for Gradient noise.
// Simplex noise, looks nicer and made by the same person.
// Fractal noise is a sum of many scales of noise
